...
FEType_ extractType(const mfem::FiniteElementSpace& fes)
{
...
mfem::SparseMatrix createPermutationMatrixFromVector(const mfem::Array<int>& p)
{
...
mfem::Array<int> createBDPermutation(const mfem::FiniteElementSpace& fes)
{
    ...
    switch (type)
    {
        ...
        case FEType_::HCURL:
            ...
            break;
        case FEType_::HDIV:
            n_dof = (dim == 2 ? mesh.GetNEdges() : mesh.GetNFaces());
            break;
        default:
            std::unreachable();
    }
    ...
    unsigned int int_idx = 0, bd_idx = n_int_dof;
...
mfem::SparseMatrix getBDPermutationMatrix(const mfem::FiniteElementSpace& fes)
{
